...
### 15-a. 배열 대신 연결 리스트 자료구조 사용하기 - 데이터 처리 코드를 분리하기 전
### 15-b. 배열 대신 연결 리스트 자료구조 사용하기 - 데이터 처리 코드를 분리하여 캡슐화 하기
### 15-c. 배열 대신 연결 리스트 자료구조 사용하기 - 데이터 처리 코드를 캡슐화 한 후



### 15. 데이터를 처리하는 코드를 별도의 클래스로 분리하기 : 캡슐화

### 16. 캡슐화와 접근 제어 : 세터(setter) / 게터(getter)
