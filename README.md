...
### 31-d. 데이터 처리 코드를 별도의 클래스로 분리하기 : 트랜잭션이 필요한 이유

### 32-a. DB 프로그래밍 더 쉽고 간단히 하는 방법 : Mybatis 퍼시스턴스 프레임워크 도입
### 32-b. DB 프로그래밍 더 쉽고 간단히 하는 방법 : Mybatis 기타 기능 활용하기
### 32-c. DB 프로그래밍 더 쉽고 간단히 하는 방법 : Mybatis에서 트랜잭션 다루기

### 33. 비즈니스 로직 분리하기 : 서비스 객체의 도입
