...
이번 훈련에서는 **character stream class** 를 활용하여 데이터를 텍스트 포맷으로 파일에 저장하고 파일에서 읽는 것을 연습할 것이다. 텍스트 형식으로 저장할 때 **CSV(Comma-Seperated Values)** 포맷으로 저장할 것이다.
